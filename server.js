...
function options(request, response, pathname) {
    response.setHeader('Access-Control-Allow-Methods', 'POST, GET, PUT, PROPFIND, OPTIONS');
...
function handleRequest(request, response) {
    ...
    if (method === 'POST') {
        return post(request, response, pathname);
    }
    /*
    if (method === 'PUT') {
    ...
    */
    if (method === 'OPTIONS') {
        return options(request, response, pathname);
    }
...
dns.lookup(os.hostname(), (err, addr, _fam) => {
